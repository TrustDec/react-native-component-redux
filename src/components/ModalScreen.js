    ...
    render() {
        return (
            <View style={styles.container}>
                <StatusBar backgroundColor={'#EFEFF4'} animated={true} barStyle="light-content" />
                <Image
                    ref={img => {
                ...
                {this.state.viewRef == null ? null : (
                    <BlurView style={styles.absolute} blurType="dark" blurAmount={3} viewRef={this.state.viewRef} />
                )}
                <ScrollView style={styles.textView} showsVerticalScrollIndicator={false}>
                    <Text style={styles.paragraphCertent}>{paragraph}</Text>
                </ScrollView>
                <View
                    style={{
                        position: 'absolute',
                        bottom: 90,
                        right: 20,
                        backgroundColor: 'rgba(23, 142, 238,.88)',
                        width: 50,
                        height: 50,
                        borderRadius: 25,
