...
import { ENTRIES1, ENTRIES2 } from '../../../equipment/static';
import { scrollInterpolators, animatedStyles } from '../../../equipment/animations';
...
export default class CarouselScreen extends Component {
    static navigationOptions = ({ navigation, navigationOptions }) => {
        ...
        return {
            title: params ? params.otherParam : 'CarouselScreen',
            headerStyle: {
                backgroundColor: '#B621FF',
                borderBottomWidth: 0
            },
            headerRight: <View />,
    ...
    customExample(number, title, refNumber, renderItemFunc) {
        ...
        return !IS_ANDROID ? (
            <View
                style={[styles.exampleContainer, isEven ? styles.exampleContainerDark : styles.exampleContainerLight]}>
